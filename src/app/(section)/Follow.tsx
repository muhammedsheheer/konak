...
const Follow: React.FC = () => {
  return (
    <section className="relative h-full w-full bg-[#c29732] px-4 pt-12 md:pt-16">
      <div className="flex flex-col gap-6 md:gap-12">
        ...
        <div className="hidden flex-col gap-4 md:flex md:flex-row md:gap-2">
          <motion.div
        ...
        <div className="grid grid-cols-2 gap-2 md:hidden">
          ...
          >
            <Image
              ...
              height={74}
              alt="frame"
              className="h-[180px] w-full md:h-[400px]"
            />
          </motion.div>
          <motion.div
            className="w-full md:w-[20%]"
